            ...
            <div className="space-y-0.5">
              {payments.map((p, i) => (
                <div key={i} className="flex justify-between">
                  <span>{PAYMENT_LABELS[p.phuongThuc] || p.nhaCungCap || 'Thanh toán'} {p.trangThaiThanhToan === 2 ? '· Đã thanh toán' : p.trangThaiThanhToan === 1 ? '· Chờ thanh toán' : p.trangThaiThanhToan === 4 ? '· Chờ hoàn tiền' : '· Thất bại'}</span>
