...
export const createBrand = (data) => api.post('/admin/brands', data).then((r) => r.data)
export const updateBrand = (id, data) => api.put(`/admin/brands/${id}`, data).then((r) => r.data)
export const deleteBrand = (id) => api.delete(`/admin/brands/${id}`).then((r) => r.data)

export const createSize = (data) => api.post('/admin/sizes', data).then((r) => r.data)
export const updateSize = (id, data) => api.put(`/admin/sizes/${id}`, data).then((r) => r.data)
export const deleteSize = (id) => api.delete(`/admin/sizes/${id}`).then((r) => r.data)

export const createColor = (data) => api.post('/admin/colors', data).then((r) => r.data)
export const updateColor = (id, data) => api.put(`/admin/colors/${id}`, data).then((r) => r.data)
export const deleteColor = (id) => api.delete(`/admin/colors/${id}`).then((r) => r.data)
