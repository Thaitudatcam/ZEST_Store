...
export const guiMaXacThucEmailMoi = (data) => api.post('/users/gui-ma-xac-thuc-email-moi', data).then((r) => r.data)
export const xacNhanEmailMoi = (data) => api.post('/users/xac-nhan-email-moi', data).then((r) => r.data)
