...
import { X, Send, Paperclip, Image, Camera, Trash2, Plus, MessageSquare } from 'lucide-react'
  ...
  return (
    <>
      {!open ? (
        ...
        <div className="fixed inset-0 sm:inset-auto sm:bottom-4 sm:right-4 sm:h-[600px] sm:w-[400px] z-50 sm:rounded-2xl sm:shadow-2xl bg-noir-900 border border-gold/15 flex flex-col overflow-hidden animate-fade-in">
              ...
              <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3" style={{ scrollBehavior: 'smooth' }}>
                {messages.length === 0 && !loading && (
                  <div className="flex flex-col items-center justify-center h-full text-center py-10">
                    ...
                    <p className="text-xs text-stone-light/40 mt-1">Hãy hỏi về sản phẩm, size, chất liệu, hoặc bất kỳ câu hỏi nào về thời trang.</p>
                  </div>
                )}
                {messages.map((m) => (
